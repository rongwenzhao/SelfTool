...
public class AsynImageLoader {
	...
	public void showConerImageAsync(final ImageView imageView,String url, final Bitmap defaultShow,final int corner){
		imageView.setTag(url);
		Bitmap bitmap = loadImageAsyn(url, new ImageCallback() {

			@Override
			public void loadImage(String path, Bitmap bitmap) {
				if (path.equals(imageView.getTag().toString())) {
					imageView.setImageBitmap(PicUtil.getRoundedCornerBitmap(bitmap,corner));
				} else {
					imageView.setImageBitmap(PicUtil.getRoundedCornerBitmap(defaultShow, corner));
				}
			}
		});
