package com.mygame.android.view.widget.viewpager.adapter;
...
import com.mygame.android.view.widget.viewpager.CommonBannerViewPager;
...
public class CommonBannerViewPagerAdapter extends CommonBannerViewPager.AbsMyViewPagerAdapter {
	...
	public void destroyItem(View container, int position, Object object) {
		...
		/*MyViewPager myViewPager = (MyViewPager) container;
		myViewPager.removeView(arrayList.get(position));*/
	}
